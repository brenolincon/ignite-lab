  ...
  return (
    <div className="flex-1">
      <div className="bg-black flex justify-center">
        <div className="h-full w-full max-w-[900px] max-h-[50vh] aspect-video">
          <Player>
      ...
      <div className="p-8 max-w-[1100px] mx-auto">
        ...
        <div className="gap-8 mt-20 grid grid-cols-2">
          <a
            href="#"
            className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 translate-colors"
          >
